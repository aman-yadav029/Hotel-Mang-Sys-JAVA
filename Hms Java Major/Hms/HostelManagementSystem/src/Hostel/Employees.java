...
public class Employees implements ActionListener, KeyListener {
    JFrame f1;
    ...
    ResultSet rs;
    public Employees() {
        f1 = new JFrame("Employees Details");
        ...
        headtext = new JLabel("Employees Details");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            ...
            if (aadhar.isEmpty() && bl=="<None>")
            {
                ...
                try {
                    con = DBConnection.createDBConnection();
                    ps = con.prepareStatement("select * from employee where Aadhar=? and Block=? and WorkingStatus=?");
                    ps.setString(1, aadhar);
                    ps.setString(2, bl);
